...
import 'package:xmeme_frontend/models/classes/postItemsClass.dart';
import 'package:xmeme_frontend/screens/IntrayPage/local_widgets/IntrayCard.dart';
...
class _IntrayPageState extends State<IntrayPage> {
  List<PostItems> feedList = [];

  @override
  Widget build(BuildContext context) {
    feedList = getIntrayCardList();
    return Container(
      ...
      child: ListView(
        ...
        children: feedList
            .map((PostItems item) => _buildListTile(context, item))
            .toList(),
      ),
    );
  }

  Widget _buildListTile(BuildContext context, PostItems item) {
    return ListTile(
      key: Key(item.key),
      title: IntrayCard(
        user: item.user,
  ...
  List<PostItems> getIntrayCardList() {
    for (var i = 0; i < 10; i++) {
      feedList.add(PostItems(
        i.toString(),
        'User' + i.toString(),
        'This is caption' + i.toString(),
